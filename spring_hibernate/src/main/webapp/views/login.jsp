          ...
          <div class = "col-lg-3 col-md-1 col-sm-12 col-xs-12"></div>
            <div class = "col-lg-6 col-md-10 col-sm-12 col-xs-12">
              ...
              <div class = "jumbotron bg-white border border-danger">
                <h1 class="text center col-lg-12 text-dark">Login Page</h1>
                <br>
                  ...
                  <br>
                  <div class = "form-group">
                      <button class="btn btn-dark btn-lg btn-block border border-danger bg-danger text-white" type="submit" value="Login">Login</button>
                  </div>
              </div>
            </div>
        </div>
